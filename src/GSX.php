...
final class GSX {
	...
	const ARTICLE_FILTER_COLUMN_SEARCH_TEXT = "SEARCH_TEXT";
	const ARTICLE_FILTER_COLUMN_PRODUCT_HIERARCHY_ID = "PRODUCT_HIERARCHY_ID";
	const ARTICLE_FILTER_COLUMN_ARTICLE_CATEGORY = "ARTICLE_CATEGORY";
	const ARTICLE_FILTER_COLUMN_SERIAL_ID = "SERIAL_ID";
	const ARTICLE_FILTER_COLUMN_PART_NUM = "PART_NUM";
	const ARTICLE_FILTER_COLUMN_FAVORITE = "FAVORITE";
	const ARTICLE_FILTER_COLUMN_PRIORITY = "PRIORITY";
	const ARTICLE_FILTER_COLUMN_ACKNOWLEDGED = "ACKNOWLEDGED";
